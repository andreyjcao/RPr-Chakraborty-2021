...
### Map race and ethnicity rates NEW

NEW MODIFICATION: We can also map the spatial distributions of the percent of black people and the percent of non-Hispanic non-White people (the two variables (with disability) with the strongest positive Pearson's r (Table 1 of original study). Mapping these two variables can help us to understand some of the local and cluster relative risk maps above (especially the clusters in the South and Southwest).

```{r map-black-rates NEW, message = FALSE}
tm_black_rates <- tm_shape(acs_covid) +
  tm_polygons("black_pct",
    title = "Percent of Black People\n(ACS 2014-2018)",
    style = "quantile",
    border.alpha = .2,
    lwd = 0.2,
    palette = "Oranges"
...
The addition of two maps (one of percentages of black people, one of percentages of non-Hispanic non-White people) helped clarify some of the local and cluster relative risk maps (especially the clusters in the South and Southwest).
